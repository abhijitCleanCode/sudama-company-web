...
const Header = () => {
  ...
  return (
    <div
      className={`absolute top-0 left-0 w-full z-50 px-6 py-6 md:py-8 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm ${
        openNavigation ? "bg-n-8" : "bg-n-8/90 backdrop-blur-sm"
      }`}
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className="flex gap-2 items-center xl:mr-8" href="#hero">
          <img
            src={Brainwave}
            width={40}
            height={40}
